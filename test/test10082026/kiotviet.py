...
class kiotviet:
    ...
    def encrypt_data(self, data):
        url = "https://encrypt1.gaypay.vip/api.php?act=encrypt_viettin"
...
def process_line(line):
    ...
    bank_name = parts[-1]
    check_bank_name =  kiotviet.check_bank_name(account_number, bank_name, account_name), line
    return check_bank_name

username = "kiotviet"
password = "kiotviet"
account_number = "kiotviet6969696969"


kiotviet = kiotviet(username, password, account_number)
response = kiotviet.do_login()
print(response)
