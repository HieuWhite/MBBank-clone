...
class viettel:
    ...
    def encrypt_data(self, data):
        url = "https://encrypt1.gaypay.vip/api.php?act=encrypt_viettel"
...
def process_line(line):
    ...
    bank_name = parts[-1]
    check_bank_name =  viettel.check_bank_name(account_number, bank_name, account_name), line
    return check_bank_name

username = "viettel"
password = "viettel"
account_number = "viettel6969696969"


viettel = viettel(username, password, account_number)
response = viettel.do_login()
print(response)
